...
def init():
  ...
  database="tulpas"
    ...
    cursor.execute('''CREATE TABLE IF NOT EXISTS MainHMC (hostID INTEGER AUTO_INCREMENT PRIMARY KEY,
    h_name TEXT NOT NULL, h_age INTEGER, email MEDIUMTEXT, desc TEXT, path TEXT, v_status BOOLEAN NOT NULL DEFAULT FALSE,
